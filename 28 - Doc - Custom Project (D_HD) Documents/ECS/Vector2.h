...
struct Vector2
{
    ...
    static Vector2 GetRotatedDegrees(Vector2 v,double degrees)
    {
        double DegToRad = M_PI / 180;
        return Vector2::GetRotatedRadians(v,degrees * DegToRad);
    }
    static Vector2 GetRotatedRadians(Vector2 v, double radians)
    {
